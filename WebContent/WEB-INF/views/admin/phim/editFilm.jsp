		...
		<div class="wraper">
			...
			<div class="login">
				<div class="container">
					...
					<div class="form mid">
						<form:form action = "admin/phim-edit.htm?p=${phim.maPhim}" enctype = "multipart/form-data" method = "post">
							<div class="name">
								<p>Tên phim: ${phim.tenPhim}</p>
								<p>Năm phát hành: ${phim.namPH}</p>
							</div>
							
							<div class="pass">
								<p>Tình trạng</p>
								<input type="text" placeholder="Tình trạng" name= "tinhTrang"/>
								<c:if test="${tt_fail != null}">
									<p >${tt_fail}</p>
								</c:if>
							</div>
