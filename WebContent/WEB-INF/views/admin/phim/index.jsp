		...
		<div class="wraper">
			...
			<div style=" background-color: #3e3e3e03;margin-top: 20px;">
				<div class="w3-bar" style="display:inline-block;background-color: #f0f8ff00; float: right;">
					<a href = "admin/phim.htm?addFilm">
						<button class="w3-button w3-red">Thêm phim</button>
					</a>
				</div>
				...
				<div class="table mid">
					<div class="thuancute">
						<table class="table table-dark">
							...
							<tbody>
								<c:forEach var = "p" items="${phim}" varStatus = "status">
									<tr>
										<th scope="row">${status.index + 1}</th>
										<td>${p.tenPhim}</td>
										<td>
											<a href = "admin/phim/${p.maPhim}.htm" style = "color:white;">Chi tiết</a>
										</td>
									</tr>
								</c:forEach>
