			...
			<div class="login">
				<div class="container">
					...
					<div class="form mid">
						...
						<form class="mid" action="dang-nhap.htm" method="post">
							<div class="email">
								<p>Email</p>
							...
							<div class="pass">
								<p>Mật khẩu</p>
								<input type="password" name="password" value="${password}" placeholder="Nhập mật khẩu" /> 
								<c:if test="${pass_fail != null}">
									<p class="err">${pass_fail}</p>
								</c:if>
